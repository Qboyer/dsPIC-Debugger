...
void initGPIO() {
    ...
    */
    ...
    TRISAbits.TRISA0 = 1;    //SPI_CLOCK
    TRISAbits.TRISA1 = 1;   //SPI_MOSI
    TRISAbits.TRISA4 = 1;   //COD_ASS_5_A
    TRISAbits.TRISA7 = 0;   //SENS_ACT_2
    TRISAbits.TRISA8 = 1;   //COD_ASS_3_A
    TRISAbits.TRISA9 = 1;   //COD_ASS_4_B
    TRISAbits.TRISA11 = 1;  //RX
    TRISAbits.TRISA15 = 0;  //SENS_ACT_6
    
    TRISBbits.TRISB0 = 1;   //SPI_SS
    TRISBbits.TRISB1 = 1;   //MES_BAT
    TRISBbits.TRISB4 = 1;   //COD_ASS_3_B
    TRISBbits.TRISB6 = 0;   //TX
    TRISBbits.TRISB8 = 1;   //I_ASS_4
    TRISBbits.TRISB9 = 1;   //I_ASS_3
    TRISBbits.TRISB10 = 0;  //PWM__ACT_4
    TRISBbits.TRISB11 = 0;  //PWM_ACT_3
    TRISBbits.TRISB12 = 0;  //PWM_ACT_5
    TRISBbits.TRISB13 = 0;  //PWM_ACT_6
    TRISBbits.TRISB15 = 0;  //PWM_ACT_2
    
    TRISCbits.TRISC0 = 1;   //COD_ASS_1_A
    TRISCbits.TRISC1 = 0;   //SPI_MISO
    TRISCbits.TRISC2 = 1;   //COD_ASS_1_B
    TRISCbits.TRISC3 = 1;   //I_ASS_6
    TRISCbits.TRISC4 = 1;   //COD_ASS_4_A
    TRISCbits.TRISC5 = 1;   //COD_ASS_6_A
    TRISCbits.TRISC6 = 0;   //SENS_ACT_5
    TRISCbits.TRISC9 = 0;   //SENS_ACT_4
    TRISCbits.TRISC10 = 1;  //I_ASS_5
    TRISCbits.TRISC12 = 1;  //COD_ASS_6_B
    
    TRISDbits.TRISD2 = 0;   //SENS_ACT_1
    TRISDbits.TRISD3 = 0;   //PWM_SERVO
    TRISDbits.TRISD4 = 0;   //PWM_ACT_1
    TRISDbits.TRISD15 = 1;  //FSR_3
            
    TRISEbits.TRISE0 = 1;   //FSR_4
    TRISEbits.TRISE1 = 1;   //COD_ASS_5_B
    TRISEbits.TRISE13 = 1;  //FSR_2
    TRISEbits.TRISE14 = 1;  //COD_ASS_2_A
    TRISEbits.TRISE15 = 1;  //COD_ASS_2_B
    
    TRISFbits.TRISF6 = 0;   //SENS_ACT_3
    
    TRISGbits.TRISG2 = 1;   //FSR_5
    TRISGbits.TRISG3 = 1;   //FSR_6
    TRISGbits.TRISG10 = 1;  //I_ASS_1 / AN22
    TRISGbits.TRISG11 = 1;  //FSR_1
    ...
    */
    ...
    ANSELBbits.ANSB1 = 1;   //MES_BAT
    ANSELBbits.ANSB8 = 1;   //I_ASS_4
    ANSELBbits.ANSB9 = 1;   //I_ASS_3
    
    ANSELCbits.ANSC3 = 1;  //I_ASS_6
    ANSELCbits.ANSC10 = 1;  //I_ASS_5
    
    ANSELDbits.ANSD15 = 1;  //FSR_3
    
    ANSELEbits.ANSE0 = 1;   //FSR_4
    ANSELEbits.ANSE13 = 1;  //FSR_2
    
    ANSELGbits.ANSG2 = 1;   //FSR_5
    ANSELGbits.ANSG3 = 1;   //FSR_6
    ANSELGbits.ANSG10 = 1;  //I_ASS_1
    ANSELGbits.ANSG11 = 1;  //FSR_1
    ANSELGbits.ANSG15 = 1;  //I_ASS2
    //1 -> open-drain
    ODCA = 0x0000;
    ODCB = 0x0000;
    ODCC = 0x0000;
    ...
    */
    ...
    CNENAbits.CNIEA4 = 1;   //COD_ASS_5_A
    CNENAbits.CNIEA8 = 1;   //COD_ASS_3_A
    CNENAbits.CNIEA9 = 1;   //COD_ASS_4_B
    
    CNENBbits.CNIEB4 = 1;   //COD_ASS_3_B
    
    CNENCbits.CNIEC0 = 1;   //COD_ASS_1_A
    CNENCbits.CNIEC2 = 1;   //COD_ASS_1_B
    CNENCbits.CNIEC4 = 1;   //COD_ASS_4_A
    CNENCbits.CNIEC5 = 1;   //COD_ASS_6_A
    CNENCbits.CNIEC12 = 1;  //COD_ASS_6_B
    
    CNENEbits.CNIEE1 = 1;   //COD_ASS_5_B
    CNENEbits.CNIEE14 = 1;   //COD_ASS_2_A
    CNENEbits.CNIEE15 = 1;   //COD_ASS_2_B
    /*
